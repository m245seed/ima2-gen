...
| Storyboard | Maintains character and scene continuity across sequential frames. | Toggle in the composer. Works for image generation; image keyframes are composed for sequential frame production. |
