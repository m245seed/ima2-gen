export const STORYBOARD_PREFIX = [
  "[STORYBOARD MODE — Keyframe / Storyboard Grid]",
  "This image is a single keyframe OR a 3x3 storyboard grid.",
  ...
  "- Do NOT add timestamp labels or text overlays to any panel.",
  ...
  "",
  "COMPOSITION:",
  "- Frame each panel with clear staging; avoid cramped or static-only poses.",
  "- Use descriptive caption format: shot type + subject action + environment + technical (lens, lighting) + mood.",
  "- End pose must be stable and suitable for continuation in the next keyframe.",
  "",
].join("\n") + "\n";
